...
public class TeleportDestination implements INBTSerializable<NBTTagCompound>
{
    ...
    {
        TeleportationWorks.MOD_LOGGER.info("TeleportDestination.serializeNBT called for " + friendlyName);
    ...
    {
        TeleportationWorks.MOD_LOGGER.info("TeleportDestination.deserializeNBT called for " + nbt.getString("FriendlyName"));
